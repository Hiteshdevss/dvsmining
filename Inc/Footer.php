      ...
      >
        <div class="flex flex-wrap justify-between">
          ...
          <div class="w-full md:w-auto text-center md:text-left mb-6">
            ...
            <ul class="list-none">
              <li class="mb-2">
                <a href="../Pages/About.php" class="text-white hover:text-orange-600"
                  >About Us</a
                >
              </li>
              <li class="mb-2">
                <a href="../Pages/Team.php" class="text-white hover:text-orange-600"
                  >Our Team</a
                >
              </li>
              <li class="mb-2">
                <a href="../Pages/Gallery.php" class="text-white hover:text-orange-600"
                  >Our Gallery</a
                >
              </li>
              <li class="mb-2">
                <a href="../Pages/Projects.php" class="text-white hover:text-orange-600"
                  >Our Projects</a
                >
              </li>
              <li class="mb-2">
                <a href="../Pages/Blog.php" class="text-white hover:text-orange-600"
                  >Our Blog's</a
                >
              </li>
              <li class="mb-2">
                <a href="../Pages/Suppliers.php" class="text-white hover:text-orange-600"
                  >Our Suppliers</a
                >
              </li>
              <li class="mb-2">
          ...
          <div class="w-full md:w-auto text-center md:text-left mb-6">
            ...
            <h6
              class="text-2xl font-bold mb-2 text-orange-500 mt-6"
              data-aos="zoom-in"
            >
              Quick Links
            </h6>
            <ul class="list-none">
            <li class="mb-2">
                <a href="../Pages/Sitemap.php" class="text-white hover:text-orange-600"
                  >Sitemap</a
                >
              </li>
              <li class="mb-2">
                <a href="../Pages/Sustainability.php" class="text-white hover:text-orange-600"
                  >Sustainability</a
                >
              </li>
              <li class="mb-2">
              ...
              <li class="mb-2">
                <a href="../Pages/Investor.php" class="text-white hover:text-orange-600"
                  >Investors</a
                >
              </li>
            </ul>
          ...
          <div class="w-full md:w-auto text-center md:text-left">
            ...
            <ul class="list-none">
              <li class="mb-2">
                <a href="mailto:info@dvsmining.com" class="text-white hover:text-orange-600"
                  ><b>Email :</b> info@dvsmining.com</a
                >
              </li>
              <li class="mb-2">
                <a href="tel:+919503865798" class="text-white"
