        ...
        <div class="flex-1 w-full h-full overflow-hidden overflow-y-auto">
            ...
            <main class="p-4 md:p-6 overflow-y-auto">
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Bar Chart for Enquiries by Month -->
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Enquiries by Month</h3>
                        <div class="relative" style="height: 300px;">
                            <canvas id="enquiryChart" class="absolute inset-0 w-full h-full"></canvas>
                        </div>
                    </div>
                    
                    <!-- Pie Chart for Enquiry Types -->
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Enquiry Types</h3>
                        <div class="relative" style="height: 300px;">
                            <canvas id="enquiryTypeChart" class="absolute inset-0 w-full h-full"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <script>
                    ...
                    createResponsiveChart(enquiryCtx, 'bar', {
                        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
                        datasets: [{
                            label: 'Number of Enquiries',
                            data: [65, 59, 80, 81, 56, 55, 40, 80, 65, 16, 0, 0],
                    ...
                    const enquiryTypeCtx = document.getElementById('enquiryTypeChart').getContext('2d');
                    createResponsiveChart(enquiryTypeCtx, 'pie', {
                        labels: ['General', 'Service', 'Product', 'Support'],
                        datasets: [{
                            data: [30, 25, 20, 25],
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.8)',
                ...
                <!-- Enquiries Post List -->
                <div class="mt-8">
                    <h2 class="text-2xl font-semibold mb-4">All Enquiries</h2>
