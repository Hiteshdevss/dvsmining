...
<section class="mr-5 md:mr-36 ml-5 md:ml-36 py-8">
      ...
      <div class="p-6 rounded-2xl" data-aos="fade-up">
        ...
        <div class="flex flex-col md:flex-row-reverse items-center">
          <img
            src="../Assets/Images/General/bg2.webp"
            alt="About Us"
          ...
          >
            ...
            value for stakeholders and companies at a global pitch. Our robust
            portfolio consists of reliable mining management services that
            include Design, Development, Engineering, Construction, and
            Financial Evaluation of small or large-scale mining projects.
          </p>
        </div>
      </div>
    </section>
    ...
    <div class="flex flex-wrap justify-center gap-4 p-4 mx-0 md:mx-36">
        <!-- Vision Card -->
